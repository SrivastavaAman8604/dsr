<?php
	...
	case'contactform':
		...
		<center style="width: 100%; background-color: #f1f1f1;">
			...
			<table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
				...
				<td style="background: #ffffff; padding: 0em 2.5em; text-align: center; background-color: #0e1029;">
				    <img src="http://www.divinesoulresonance.com/assets/img/logo/archana-new-logo.png" style="width: 20%; padding-top: 15px;">
				</td>
			    </tr>
			    <tr>
					...
					<tr>
						...
						<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
							...
							<td style="text-align: center; padding-right: 10px; font-family: oswald,sans-serif;">
							    ...
							    Email : 
							    <a style="color:#557e00; text-decoration: none;" href="mailto:archana@divinesoulresonance.com" target="_blank" rel="noreferrer">archana@divinesoulresonance.com</a>
							    <a style="color:#557e00; text-decoration: none;" href="http://www.divinesoulresonance.com" target="_blank" rel="noreferrer">www.divinesoulresonance.com</a>
							    </p>
							</td>
						    </tr>
						</table>
	    ...
	    $to = "archana@divinesoulresonance.com";
	    // $headers[] = 'MIME-Version: 1.0';
	    // $headers[] = 'Content-type: text/html; charset=iso-8859-1';
	    // $headers[] = 'From: Divine Soul Resonance <archana@divinesoulresonance.com>';
	    // $headers[] = "Bcc: 'rahulkumarmaurya464@gmail.com'\r\n";

		  $headers = "MIME-Version: 1.0" . "\r\n";
		  $headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
		  $headers .= 'From:archana@divinesoulresonance.com' . "\r\n";

	    // $mail = mail ($to,$subject,$contact_us_enquiry_msg,implode("\r\n", $headers));
	    $mail_to_akshat = mail ('akshat.gd@gmail.com',$subject,$contact_us_enquiry_msg,$headers);
	    if($mail_to_akshat==1){
			$response=1;
	    ...
	    $headers[] = 'MIME-Version: 1.0';
	    $headers[] = 'Content-type: text/html; charset=iso-8859-1';
	    $headers[] = 'To: archana@divinesoulresonance.com';
